            ...
            <div className="flex-1 overflow-y-auto p-8 md:p-12">
              <div className="space-y-6 text-[#171a20]/80 leading-relaxed text-base md:text-lg">
                ...
                <p className="font-medium text-[#171a20]">
                  未来，寅时智能将始终以 AI 前沿技术为核心引擎，依托产学研深度协同的创新生态，深耕生物制药、生命科学、材料工程等关键领域。我们持续打磨稳定、高效、定制化的一体化智能解决方案，聚焦产业痛点，释放科技价值，以数智力量驱动产业变革、赋能提质升级，携手各行各业奔赴数字化、智能化高质量发展新征程。
                </p>
                <p className="font-bold text-[#171a20] text-center text-lg mt-8 tracking-widest text-cyan-700">
                  时序寅光，智启新程！
                </p>
              </div>
